...
export function QuoteDetailItems({ quote }: { quote: Quote }) {
  return (
    <div className="mb-6">
      <TypographyH2 className="text-base font-semibold mb-4">Positionen</TypographyH2>

      <div className="flex flex-col gap-2">
        <div className="grid grid-cols-[1fr_60px_100px_100px] gap-2 text-xs text-zinc-400 px-1">
        ...
        {quote.items.map((item) => (
          <div
            key={item.id}
            className="grid grid-cols-[1fr_60px_100px_100px] gap-2 py-2 border-b border-zinc-800 text-sm px-1"
          >
